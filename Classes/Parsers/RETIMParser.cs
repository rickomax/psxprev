...
{
    public class RETIMParser
    {
        private long _offset;

        public List<Texture.Texture> LookForTim(BinaryReader reader, string fileTitle)
        {
            if (reader == null)
            {
                    ...
                    if (id == 0x10)
                    {
                        ...
                        if (foundTextures != null)
                        {
                            for (var t = 0; t < foundTextures.Length; t++)
                            {
                                ...
                                Program.Logger.WriteLine("Found Resident Evil TIM Image at offset {0:X}", _offset);
                            }
                        }
                    }
                }
        ...
        private Texture.Texture[] ParseRETim(BinaryReader reader)
        {
            ...
            var textures = new Texture.Texture[numTextures];
            ...
            if (flag == 0x08)
            {
                ...
                {
                    textures[i] = new Texture.Texture(textureWidth / numTextures, textureHeight, 0, 0, textureBpp, 0);
                }
            ...
            else
            {
                ...
                textureHeight = imgHeight;
                textureBpp = 16;
                textures[0] = new Texture.Texture(textureWidth, textureHeight, 0, 0, textureBpp, 0);
