...
namespace PSXPrev.Classes.Scene
{
    public class Scene
    {
        ...
        private Color.Color _clearColor;
        ...
        public void Draw(int selectedTriangle)
        {
        ...
        public void FocusOnBounds(BoundingBox.BoundingBox bounds)
        {
            _cameraYaw = 0f;
            _cameraPitch = 0f;
        ...
        public void DistanceToFitBounds(BoundingBox.BoundingBox bounds)
        {
